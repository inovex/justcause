...
module_dir = os.path.join(__location__, "../src/justcause")
try:
...
project = u'JustCause'
copyright = u'2020, Maximilian Franz, Florian Wilhelm'
...
try:
    from justcause import __version__ as version
except ImportError:
    pass
else:
    release = version
...
htmlhelp_basename = 'justcause-doc'
...
latex_documents = [
  ('index', 'user_guide.tex', u'justcause Documentation',
